...
public:
    ...
    void writeSetupRegister(byte operationMode, byte gain, byte polarity, byte buffered, byte fsync);
    double readValue(byte channel, float refOffset = 0.0);
    void reset();
